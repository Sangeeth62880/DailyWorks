...
export default function JobDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Use a React hook to fetch data
  const jobPromise = getJob(id)
  ...
  // Use a React hook to fetch similar jobs
  const similarJobsPromise = getSimilarJobs(id, job.category)
  const similarJobs = use(similarJobsPromise)
